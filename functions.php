...
function thiagoandradewp_setup() {
	/*
		...
		* If you're building a theme based on Thiago Andrade, use a find and replace
		* to change 'thiagoandradewp' to the name of your theme in all the template files.
		*/
